...
for fil in os.listdir("Objects/"):
    if fil[0]=='R':
        ...
        plt.plot([10,20,30,40], rjr_test, 'b+', ms=15)
        plt.ylim(0.98,1)
        ...
        plt.plot([10,20,30,40], fjr_test, 'b+', ms=15)
        plt.ylim(0.6,1)
        ...
        plt.plot([10,20,30,40], sjr_test, 'b+', ms=15)
        plt.ylim(0,1)
        ...
        plt.plot([10,20,30,40], rjr_train, 'b+', ms=15)
        plt.ylim(0.98,1)
        ...
        plt.plot([10,20,30,40], fjr_train, 'b+', ms=15)
        plt.ylim(0.6,1)
        ...
        plt.plot([10,20,30,40], sjr_train, 'b+', ms=15)
        plt.ylim(0,1)
        ...
        plt.plot([10,20,30,40], fo_test, 'b+', ms=15)
        plt.ylim(0,1)
        ...
        plt.plot([10,20,30,40], fi_test, 'b+', ms=15)
        plt.ylim(0,1)
        ...
        plt.plot([10,20,30,40], fo_train, 'b+', ms=15)
        plt.ylim(0,1)
